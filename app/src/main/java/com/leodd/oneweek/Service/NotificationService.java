...
//
//                    Plan plan = mNotificationBO.getCurrentPlanBeanByTime(current);
//
//                    if(plan != null) {
//                        showNotification(plan.getContent());
//                    }
//                }
//
...
//        int hour = calendar.get(Calendar.HOUR_OF_DAY);
//
//        Plan plan = mNotificationBO.getNextPlanBeanByTime(new TimeObject(hour, minute));
//
//        if(plan != null) {
//            calendar.set(Calendar.HOUR_OF_DAY, plan.getTime().getHour());
//            calendar.set(Calendar.MINUTE, plan.getTime().getMinute());
