...
/**
 * Created by leodd on 2016/12/23.
 * the divider of the recycler view
 */
...
public class PlanDivider extends RecyclerView.ItemDecoration {
    ...
    public PlanDivider(Drawable divider, int orientation) {
        setDivider(divider);
    ...
    private void setDivider(Drawable divider) {
        ...
        if (mDivider == null) {
            mDivider = new ColorDrawable(0x00000000);
        }
